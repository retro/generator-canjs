...
This section will walk you through setting up the [repository](https://github.com/<%= githubAccount %>/<%= name %>) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork <%= name %>, you can start by going to its [fork page](https://github.com/<%= githubAccount %>/<%= name %>/fork).
